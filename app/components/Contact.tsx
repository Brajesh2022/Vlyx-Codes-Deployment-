...
import { Mail, MapPin, Phone, Loader2, MessageSquare, Instagram, Youtube } from "lucide-react"
...
export default function Contact() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const message = `New Contact Form Submission from Vlyx Codes:\n\nName: ${data.name}\nEmail: ${data.email}\nSubject: ${data.subject}\nMessage: ${data.message}`

      // Encode the message for WhatsApp URL
      const encodedMessage = encodeURIComponent(message)

      // WhatsApp URL with your number
      const whatsappUrl = `https://wa.me/918271081338?text=${encodedMessage}`
            ...
            <div className="bg-white dark:bg-neutral-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:scale-110 transition-transform duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-white hover:scale-110 transition-transform duration-300"
                  >
                    <Youtube className="w-5 h-5" />
                  </a>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
                  Follow us for web development tips, tutorials, and behind-the-scenes content!
                </p>
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">Co-Founder:</span> Aadish
                  </p>
                </div>
              </div>
            </div>
