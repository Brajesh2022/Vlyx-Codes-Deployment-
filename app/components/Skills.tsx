...
import { Code, Layout, Terminal, Layers, Globe, Workflow } from "lucide-react"
...
const skills = [
  ...
  },
  {
    ...
    name: "Web Design",
    tech: "CSS, Bootstrap",
    description: "Creating beautiful and user-friendly website designs that engage visitors.",
    color: "text-pink-500",
  },
  {
    icon: Globe,
    name: "Innovative Solutions",
    tech: "Blogger, Custom Hosting",
    description: "Creative approaches to hosting and content management for optimal performance.",
  ...
  },
  {
    ...
    tech: "Speed Optimization, SEO",
    description: "Ensuring websites load quickly and rank well in search engines.",
    color: "text-purple-500",
  },
  {
    icon: Layers,
    name: "CMS Experience",
    tech: "WordPress, Blogger",
    description: "Experience with content management systems and custom solutions.",
  ...
  return (
    <section id="skills" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSectionHeader title="Our Skills & Expertise" />
